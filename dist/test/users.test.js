...
describe('GET api/v1/users', () => {
    test('responds with JSON object of users', (done) => __awaiter(this, void 0, void 0, function* () {
...
describe('GET api/v1/users/:id', () => {
    test('responds with single JSON user object', (done) => __awaiter(this, void 0, void 0, function* () {
...
describe('POST api/v1/users', () => {
    ...
    test('responds with single JSON object', (done) => __awaiter(this, void 0, void 0, function* () {
...
describe('PUT api/v1/users', () => {
    ...
    test('responds with JSON object', (done) => __awaiter(this, void 0, void 0, function* () {
        yield request(app_1.default)
            .put('/api/v1/users')
            .send(testJSON)
            .expect(200)
